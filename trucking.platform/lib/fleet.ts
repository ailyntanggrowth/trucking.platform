...
export type FleetDocument = { id:string; ownerKind:EntityKind; ownerId:string; type:string; issued:string; expires:string; reviewed:boolean; notes:string; filename:string; file:Blob; uploadedAt:string; reviewedAt?:string };
