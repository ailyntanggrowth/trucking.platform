  ...
  return <main className="shell">
    ...
    {activeModule===null ? <section className="landingHero" id="main-content" tabIndex={-1}>
      ...
      <header className="topbar">
        ...
        <button className="textButton" onClick={()=>go('alertas')}>{t('Alertas')} {fleetReady?`(${alerts.length})`:''}</button>
      </header>
...
<style jsx>{`
                ...
                .langToggle { position:fixed; top:18px; right:20px; z-index:50; background:#fff; color:#6B1F2B; border:1px solid #E3DADD; border-radius:20px; width:44px; height:36px; min-height:36px; padding:0; font-size:13px; font-weight:700; letter-spacing:.5px; box-shadow:0 2px 10px #4A142014; }
                ...
                .topbar { min-height: 80px; border-bottom: 1px solid #E3DADD; display: flex; justify-content: space-between; align-items: center; gap: 16px; padding-left:56px; }.breadcrumb { color: #4A4640; font-size: 14px; display: flex; gap: 10px; flex-wrap: wrap; }.breadcrumb b { font-weight: 400; }.breadcrumb strong { color: #4A1420; }
                .backButton { border:0; background:transparent; color:#6B1F2B; font-size:14px; font-weight:700; padding:8px 10px; border-radius:8px; transition:background 180ms ease, color 180ms ease; }
                ...
                .metricsGrid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 16px; }.metricCard { background: white; padding: 20px; border: 1px solid #E3DADD; border-top: 3px solid #6B1F2B; border-radius: 12px; min-width: 0; text-align:left; }.metricTop { display: flex; justify-content: space-between; align-items: center; gap: 8px; color: #4A4640; font-size: 14px; font-weight: 700; }.metricCard > strong { display: block; margin: 12px 0 8px; color: #4A1420; font-size: 32px; line-height: 1.2; letter-spacing: -.6px; }.metricDelta { font-size: 14px; font-weight: 700; color: #6B1F2B; }.metricDelta em { display: inline-block; font-style: normal; font-weight: 400; color: #4A4640; }
                ...
                .panel { min-width: 0; background: #fff; border: 1px solid #E3DADD; border-radius: 12px; box-shadow: 0 3px 14px #4A142004; }.panelHeader { display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px; padding: 22px; }.panelHeader h2 { margin: 0; color: #4A1420; font-size: 20px; line-height: 1.3; }.panelHeader p { margin: 6px 0 0; color: #4A4640; font-size: 14px; }.textButton { border: 0; background: transparent; color: #6B1F2B; font-size: 14px; font-weight: 700; padding: 8px; border-radius:8px; transition:background 180ms ease; }.textButton:hover { background: #F5EBED; }.cellMuted { display: block; color: #4A4640; font-size: 13px; margin-top: 5px; }.status { display: inline-flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 700; border-radius: 8px; padding: 5px 8px; }.statusTransit { color: #6B1F2B; background: #F5EBED; }
                ...
                button, .loadRow summary { transition:background 200ms ease, border-color 200ms ease, box-shadow 200ms ease, transform 180ms ease, color 200ms ease; }
                .loadList { animation:enterPanel 240ms ease-out; }
                .loadRow[open] .loadDetails { animation:revealDetail 240ms ease-out; }
                .detailToggle { color:#4A4640; font-size:14px; }.detailArrow { display:inline-block; transition:transform 220ms ease; }
                ...
                @media(hover:hover) and (pointer:fine) {
                  ...
                  .statusGrid button:hover:not([aria-pressed=true]) { transform:scale(1.05); border-color:#C5A46D; box-shadow:0 6px 16px #4A142014; z-index:1; }
